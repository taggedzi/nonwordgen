...
def test_available_languages_list() -> None:
    ...
    assert "czech" in langs
    assert "hungarian" in langs
...
def test_polish_language_plugin_generates_words() -> None:
    gen = WordGenerator(
        allow_real_words=True,
...
def test_czech_language_plugin_generates_words() -> None:
    gen = WordGenerator(
        allow_real_words=True,
...
def test_hungarian_language_plugin_generates_words() -> None:
    gen = WordGenerator(
        allow_real_words=True,
...
def test_greek_language_plugin_generates_words() -> None:
    gen = WordGenerator(
        allow_real_words=True,
...
def test_thai_language_plugin_generates_words() -> None:
    gen = WordGenerator(
        allow_real_words=True,
...
def test_hebrew_language_plugin_generates_words() -> None:
    gen = WordGenerator(
        allow_real_words=True,
...
def test_scb_language_plugin_generates_words() -> None:
    gen = WordGenerator(
        allow_real_words=True,
...
def test_malay_language_plugin_generates_words() -> None:
    gen = WordGenerator(
        allow_real_words=True,
